"""Switch the staged Deck card-form clarity release on the TelBattle VPS."""
import hashlib
import json
import os
...
PREVIOUS = ROOT / 'releases/20260925-deck-final-reveal-v1'
RELEASE = ROOT / 'releases/20260925-deck-form-clarity-v1'
...
def switch(target):
    temporary = ROOT / 'current-deck-form-clarity-20260925.tmp'
...
def main():
    ...
    manifest = json.loads(Path('/tmp/telbattle-deck-form-clarity-20260925-manifest.json').read_text())
    ...
    backup = ROOT / 'backups/game_bot-before-deck-form-clarity-20260925.db'
    if backup.exists():
