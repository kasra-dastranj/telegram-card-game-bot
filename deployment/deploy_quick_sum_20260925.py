...
PREVIOUS = ROOT / 'releases/20260925-collection-fixes-v1'
RELEASE = ROOT / 'releases/20260925-quick-sum-v1'
...
def switch(target):
    temporary = ROOT / 'current-quick-sum-20260925.tmp'
...
def main():
    ...
    manifest = json.loads(Path('/tmp/telbattle-quick-sum-20260925-manifest.json').read_text())
    ...
    backup = ROOT / 'backups/game_bot-before-quick-sum-20260925.db'
    if backup.exists():
