...
PREVIOUS = ROOT / 'releases/20260923-game-integrity-v1'
RELEASE = ROOT / 'releases/20260925-collection-fixes-v1'
...
def switch(target):
    temporary = ROOT / 'current-collection-20260925.tmp'
...
def main():
    ...
    manifest = json.loads(Path('/tmp/telbattle-collection-20260925-manifest.json').read_text())
    ...
    backup = ROOT / 'backups/game_bot-before-collection-20260925.db'
    if backup.exists():
